	...
	public:
		...
		public:
			MnaPreStep(CurrentSource& currentSource) :
				Task(currentSource.mName + ".MnaPreStep", currentSource.mSubsystem), mCurrentSource(currentSource)
			{
		...
		public:
			MnaPostStep(CurrentSource& currentSource, Attribute<Matrix>::Ptr leftSideVector) :
				Task(currentSource.mName + ".MnaPostStep", currentSource.mSubsystem), mCurrentSource(currentSource), mLeftVector(leftSideVector)
			{
