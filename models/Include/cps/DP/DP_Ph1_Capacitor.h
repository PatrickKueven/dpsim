	...
	public:
		...
		public:
			MnaPreStep(Capacitor& capacitor)
				: Task(capacitor.mName + ".MnaPreStep", capacitor.mSubsystem), mCapacitor(capacitor) {
		...
		public:
			MnaPostStep(Capacitor& capacitor, Attribute<Matrix>::Ptr leftVector)
				: Task(capacitor.mName + ".MnaPostStep", capacitor.mSubsystem), mCapacitor(capacitor), mLeftVector(leftVector) {
		...
		public:
			MnaPreStepHarm(Capacitor& capacitor)
				: Task(capacitor.mName + ".MnaPreStepHarm", capacitor.mSubsystem),
		...
		public:
			MnaPostStepHarm(Capacitor& capacitor, const std::vector<Attribute<Matrix>::Ptr> &leftVectors)
				: Task(capacitor.mName + ".MnaPostStepHarm", capacitor.mSubsystem),
