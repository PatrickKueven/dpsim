	...
	public:
		...
		public:
			MnaPreStep(Inductor& inductor) :
				Task(inductor.mName + ".MnaPreStep", inductor.mSubsystem), mInductor(inductor) {
		...
		public:
			MnaPostStep(Inductor& inductor, Attribute<Matrix>::Ptr leftVector) :
				Task(inductor.mName + ".MnaPostStep", inductor.mSubsystem),
		...
		public:
			MnaPreStepHarm(Inductor& inductor)
				: Task(inductor.mName + ".MnaPreStepHarm", inductor.mSubsystem),
				mInductor(inductor) {
		...
		public:
			MnaPostStepHarm(Inductor& inductor, const std::vector<Attribute<Matrix>::Ptr> &leftVectors)
				: Task(inductor.mName + ".MnaPostStepHarm", inductor.mSubsystem),
