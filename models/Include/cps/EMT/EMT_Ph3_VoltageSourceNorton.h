			...
			public:
				...
				public:
					MnaPreStep(VoltageSourceNorton& VoltageSourceNorton) :
						Task(VoltageSourceNorton.mName + ".MnaPreStep", VoltageSourceNorton.mSubsystem), mVoltageSourceNorton(VoltageSourceNorton) {
				...
				public:
					MnaPostStep(VoltageSourceNorton& VoltageSourceNorton, Attribute<Matrix>::Ptr leftVector) :
						Task(VoltageSourceNorton.mName + ".MnaPostStep", VoltageSourceNorton.mSubsystem), mVoltageSourceNorton(VoltageSourceNorton), mLeftVector(leftVector)
					{
