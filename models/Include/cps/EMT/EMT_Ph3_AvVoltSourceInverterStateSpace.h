	...
	public:
		...
		public:
			MnaPreStep(AvVoltSourceInverterStateSpace& avVoltSourceInverterStateSpace) :
				Task(avVoltSourceInverterStateSpace.mName + ".MnaPreStep", avVoltSourceInverterStateSpace.mSubsystem), mAvVoltSourceInverterStateSpace(avVoltSourceInverterStateSpace) {
		...
		public:
			MnaPostStep(AvVoltSourceInverterStateSpace& avVoltSourceInverterStateSpace, Attribute<Matrix>::Ptr leftVector) :
				Task(avVoltSourceInverterStateSpace.mName + ".MnaPostStep", avVoltSourceInverterStateSpace.mSubsystem), mAvVoltSourceInverterStateSpace(avVoltSourceInverterStateSpace), mLeftVector(leftVector)
			{
