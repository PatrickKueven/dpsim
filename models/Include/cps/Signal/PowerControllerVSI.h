	...
	public:
        ...
        public:
			PreStep(PowerControllerVSI& powerControllerVSI) :
                Task(powerControllerVSI.mName + ".PreStep", powerControllerVSI.mSubsystem), mPowerControllerVSI(powerControllerVSI) {
		...
		public:
			Step(PowerControllerVSI& powerControllerVSI) :
				Task(powerControllerVSI.mName + ".Step", powerControllerVSI.mSubsystem), mPowerControllerVSI(powerControllerVSI) {
